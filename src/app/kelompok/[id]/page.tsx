...
export default function KelompokDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchData = async () => {
    ...
    // 3. Cek Absen di Tanggal Terpilih
    ...
    // 4. Cek Jurnal di Tanggal Terpilih
  ...
  const handleSaveAbsensi = async () => {
    ...
    try {
        ...
        // 2. Insert Pembayaran (Hanya yg dicentang)
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col">
            ...
            <div className="fixed bottom-24 left-4 right-4 z-50">
                <button 
                    ...
                    disabled={saving}
                    className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-blue-200 flex justify-center items-center gap-2 hover:bg-blue-700 transition-all active:scale-95 border-2 border-white/20"
                >
